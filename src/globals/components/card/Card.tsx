      ...
      <div className=" pb-5">
        <div className="flex items-center justify-between mt-2.5 mb-5">
          ...
          <button
            ...
            className="text-white bg-[#dc3545] hover:bg-[#dc3545] font-medium rounded-lg text-sm px-2 py-1 md:px-5 md:py-2.5 text-center transition-all duration-300 ease-in-out transform hover:scale-105"
          >
            Add to cart
          </button>
        </div>
